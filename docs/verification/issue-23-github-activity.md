...
- `npm run github:snapshot` was run with the authenticated local GitHub session to create the checked-in artifact. The artifact contains a 365-day calendar, rolling 90-day totals, and repository data retained for future use.
